class Boss {// crea una clase llamada Enemigo
  ...
  Boss(int py) {// enemigo recibe valores py
    ...
    if (coin <7) {// si coin es menor a 5
  ...
  void avanzar() {// permite el movimiento de los enemigos
    if (atqPicada) {
      ...
      if (x > 490) {// si x es mayor a 590
        derecha=false;// derecha pasa a ser falso
      }
      if (x<100) {// si x es menor a 10
